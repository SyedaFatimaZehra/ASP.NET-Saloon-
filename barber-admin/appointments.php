...
include 'Includes/templates/header.php'; // Adjust path if necessary
                ...
                <table class="table table-bordered tabcontent" id="All" width="100%" cellspacing="0" style="display: none;">
                    ...
                    <tbody>
                        ...
                        foreach ($rows_all as $row_all) {
                            ...
                            echo "</td>";
                            echo "<td>Active</td>"; // Status for active bookings
                            echo "</tr>";
                        }
                        ?>
                    </tbody>
                ...
                <table class="table table-bordered tabcontent" id="Canceled" width="100%" cellspacing="0" style="display: none;">
                    ...
                    <tbody>
                        ...
                        foreach ($rows_canceled as $row_canceled) {
                            ...
                            echo "</td>";
                            echo "<td>Canceled</td>"; // Status for canceled bookings
                            echo "</tr>";
                        }
                        ?>
                    </tbody>
...
<?php
// Include Footer
include 'Includes/templates/footer.php'; // Adjust path if necessary
