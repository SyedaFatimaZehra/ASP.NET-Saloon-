  		...
  		<div id="wrapper">
			...
			<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
			  	...
			  	<li class="nav-item active">
					<a class="nav-link" href="receptionist-dashboard.php">
				...
				<li class="nav-item">
					<a class="nav-link" href="resecptionist-services.php">
		  				<i class="bs bs-scissors-1"></i>
		  				<span>Services</span>
		  			</a>
	  			</li>
	  			<li class="nav-item">
					<a class="nav-link" href="resecptionist-service-catagories.php">
	  			...
	  			<li class="nav-item">
					<a class="nav-link" href="resecptionist-appointments.php">
				...
				<!-- Divider -->
	  			...
	  			<li class="nav-item">
					<a class="nav-link" href="resecptionist-clients.php
					">
					  	...
					  	<ul class="navbar-nav ml-auto">
							...
							<li class="nav-item dropdown no-arrow">
							  	...
							  	<div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
									...
									<a class="dropdown-item" href="resecptionist-appointments.php">
									<i class="fa fa-bell text-gray-400"></i>
								  		Appointments
									</a>
